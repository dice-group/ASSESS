    ...
    $.widget("daredevel.tree", {
        ...
        _attachNode: function (li, parentLi, position) {
            ...
            if (undefined == parentLi) {
                ...
                parent.removeClass('leaf collapsed').addClass('collapsed'); //@todo find right way to do this
        ...
        _buildNode: function (attributes) {
            ...
            //hacked so boxes are shown
            if (true) {
                var input = $('<input type="checkbox" style="margin-left:0px"/>',
                    attributes.input
                );
                li.append(input);
